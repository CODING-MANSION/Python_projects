...
#LOGIN PAGE WINDOW
def Entry():
    global userbox,passbox,login,topframe,bottomframe,image_1,root
    root = tkinter.Tk()
    ...
    bottomframe.pack()
    heading = tkinter.Label(topframe, text="WELCOME TO MIT NURSING",bg='white',fg='orange',font='Times 16 bold italic')
